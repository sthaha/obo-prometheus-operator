...
require (
	github.com/rhobs/obo-prometheus-operator v0.65.1-rhobs2
	github.com/rhobs/obo-prometheus-operator/pkg/apis/monitoring v0.65.1-rhobs2
	github.com/rhobs/obo-prometheus-operator/pkg/client v0.65.1-rhobs2
)
