...
IMAGE_OPERATOR?=quay.io/sthaha/obo-prometheus-operator
IMAGE_RELOADER?=quay.io/sthaha/obo-prometheus-config-reloader
IMAGE_WEBHOOK?=quay.io/sthaha/obo-admission-webhook
